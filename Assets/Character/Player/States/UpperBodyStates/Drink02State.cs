...
{
    public class Drink02State : PlayerState
    {
        private float timer = 0;
        public Drink02State(Player player, string animName, bool applyRootMotion) : base(player, animName, applyRootMotion)
        {
        }
